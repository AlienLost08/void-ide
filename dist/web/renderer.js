...
window.onerror = function(msg, url, line, col, error) {
  console.error('VOID IDE Error:', msg, 'at line', line);
  return false;
};
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Check if Three.js is already loaded via script tags
  if (window.THREE) {
    THREE = window.THREE;
  ...
  if (window.CANNON) {
    ...
    console.log('Cannon.js found');
  } else {
    console.log('Cannon.js not loaded (physics unavailable)');
  }
